...
contract BimaToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x295dc158b4BD98aCA981Ed8ec06E34969F8473A0); // Marketing Address
    ...
    string private _name = "Bima Token";
    string private _symbol = "BIMA";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 500 * 10**18;
    ...
    function setTaxes(uint256 newRewardFee, uint256 newLiquidityFee, uint256 newMarketingfee, uint256 newBurnFee) external onlyOwner() {
